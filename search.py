...
def crawl_pikabu(start_url, max_urls):
  visited_urls = set()
  urls_to_visit = [start_url]
  count_url = 0
  i = 0

  with open('content/index.txt', 'w', encoding='utf-8') as index_file:
    while i < max_urls:
      ...
      if response.status_code == 200:
        ...
        if 'story' in current_url and '#comments' not in current_url and 'cid' not in current_url and '?' not in current_url:

          # Сохранение HTML-данных в файл
          filename = f"content/downloaded_pages/{i}.html"
